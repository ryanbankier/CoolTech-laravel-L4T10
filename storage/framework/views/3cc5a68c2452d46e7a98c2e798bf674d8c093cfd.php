...
<div class="container-fluid">
    ...
    <?php $__currentLoopData = $hardReviews; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $hardReview): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <h2><a href="article/<?php echo e($hardReview->id); ?>"><?php echo e($hardReview->title); ?></a></h2>
        <p><?php echo e($hardReview->created); ?> | Category: <a href="category/<?php echo e($hardReview->cat_slug); ?>"><?php echo e($hardReview->category); ?></a> | Tags: <?php echo e($hardReview->tags); ?></p>
        
        <p><?php echo e(substr($hardReview->content, 0, 350)); ?> <a href="article/<?php echo e($hardReview->id); ?>">Read More</a></p>
...
</html><?php /**PATH C:\Users\Bane\Dropbox\rb21100002484\4. Advanced Web Development with the MERN Stack\Task 10\cool-tech\resources\views/hardware.blade.php ENDPATH**/ ?>