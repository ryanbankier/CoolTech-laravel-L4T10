...
<?php endif; ?>
    ...
    <h1>Articles</h1>
        <?php $__currentLoopData = $tags; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $article): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>

        <h2><a href="article/<?php echo e($article->id); ?>"><?php echo e($article->title); ?></a></h2>
        <p><?php echo e($article->created); ?> | Category: <a href="category/<?php echo e($article->cat_slug); ?>"><?php echo e($article->category); ?></a> | Tags: 
        <!--Tags--> 
        <?php
        ...
        <p><?php echo e(substr($article->content, 0, 350)); ?> <a href="article/<?php echo e($article->id); ?>">Read More</a></p>
...
</html><?php /**PATH C:\Users\Bane\Dropbox\rb21100002484\4. Advanced Web Development with the MERN Stack\Task 10\cool-tech\resources\views/tags.blade.php ENDPATH**/ ?>