...
<form action="add" method="post">
    ...
    <input class="form-control" type="text" name="title" size="72" value="<?php echo e(old('title')); ?>">
...
unset($__errorArgs, $__bag); ?></span><br>
    ...
    <textarea class="form-control" name="content" value="<?php echo e(old('content')); ?>" cols="60" rows="20"></textarea>
...
</html><?php /**PATH C:\Users\Bane\Dropbox\rb21100002484\4. Advanced Web Development with the MERN Stack\Task 10\cool-tech\resources\views/admin/author.blade.php ENDPATH**/ ?>