...
<div class="container-fluid">
    <h1>Tech News</h1>
    <?php $__currentLoopData = $techNews; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $news): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <h2><a class="text-decoration-none" href="article/<?php echo e($news->id); ?>"><?php echo e($news->title); ?></a></h2>
        <p><?php echo e($news->created); ?> | Category: <a class="text-decoration-none" href="category/<?php echo e($news->cat_slug); ?>"><?php echo e($news->category); ?></a> | Tags: 
        ...
        <?php endfor; ?>
        <!--end of tags-->
        <p><?php echo e(substr($news->content, 0, 350)); ?> <a class="text-decoration-none" href="article/<?php echo e($news->id); ?>">Read More</a></p>
...
</html><?php /**PATH C:\Users\Bane\Dropbox\rb21100002484\4. Advanced Web Development with the MERN Stack\Task 10\cool-tech\resources\views/tech-news.blade.php ENDPATH**/ ?>